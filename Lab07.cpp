...
public:
   ...
   // Vectors to hold the stars and star phases
   ...
   double angleShip;
   double angleEarth;
   double gpsAngle; // Angle to keep track of the GPS satellite angle
};
...
void callBack(const Interface* pUI, void* p)
{
   ...
   pDemo->gps.updateSatellite(pDemo->ptGPS, timePerFrame);
